...
const User = (props) => {
    ...
    let btn = props.followed ?  <button onClick={() => props.onUnfollowUser(props.id)} id={props.id}>Unfollow</button>
            :  <button onClick={() => props.onFollowUser(props.id)} id={props.id}>Follow</button>;
  return (
